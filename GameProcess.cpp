...
//void GameProcess::SetSendProc(char)
//{
//	
//	///pSendFunc = pSend;
//
...
void GameProcess::RematchProcess(TCHAR* buf)
{
	if (_tcscmp(buf, _T("1")))
	{
		startGame();
